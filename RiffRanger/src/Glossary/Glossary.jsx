    ...
    <div className='flex flex-col bg-color1 h-screen'>
      ...
      <div className='flex flex-col'>
        <div className='flex flex-row'>
          <button onClick={()=>{fetchMeaning("A")}} className='text-white border m-3 px-4 py-3 rounded-lg  hover:bg-purple-700 px-4 py-2 rounded-md transition duration-300 ease-in-out'>A</button>
