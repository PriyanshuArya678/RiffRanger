            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="mb-8">
                        ...
                        <p>Explore our wide range of guitar courses, expand your musical vocabulary with our comprehensive glossary, and challenge yourself with our engaging Sound Guessing Game. Whether you're a beginner picking up your first guitar or an experienced player looking to refine your skills, RiffRanger is here to inspire and support your musical journey. Join our community today and discover the joy of playing guitar!"</p>
                    </div>
                    <div className="mb-8">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="/store" className="hover:text-orange-500">Store</a></li>
                            <li><a href="/contact" className="hover:text-orange-500">Contact</a></li>
                        </ul>
                    </div>
                    <div className="mb-8">
                        <h3 className="text-lg font-bold mb-4">Contact Info</h3>
                        <p>123 Orange St, New Delhi</p>
                        <p>Email: info@RiffRanger.com</p>
                        <p>Phone: +123 456 7890</p>
                    </div>
                    <div>
                        <h3 className="text-lg font-bold mb-4">Follow Us</h3>
                        <div class="flex justify-center items-center gap-4 mt-10 bg-white  h-20 sm:w-[40%] lg:w-full">
        ...
        >
          ...
          ></path>
                ...
                <div className="mt-8 text-center">
                    <p>&copy; 2024 RiffRanger. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
